...
<head>
    ...
    <title>Select Role - Addwise</title>
...
<body>
    <div class="form-container">
        <form id="roleForm" action="process_role.php" method="post" onsubmit="return validateForm()">
            ...
            <div class="role-container">
                <div class="role-card">
                    ...
                    <label for="role_user">
                        ...
                        <div class="role-description">
                            Create an account to access our platform's features and services.
                            Perfect for students and general users.
                        </div>
                    </label>
                </div>
                ...
                <div class="role-card">
                    ...
                    <label for="role_admin">
                        ...
                        <div class="role-description">
                            Administrative access for managing users and platform settings.
                            Requires authorized email domain.
                        </div>
                    </label>
                </div>
            </div>
            ...
            <p class="switch">Already have an account? <a href="select_role_login.php">Login</a></p>
        </form>
    </div>
    ...
    <script>
        ...
        document.querySelector('.switch a').addEventListener('click', function(e) {
            e.preventDefault();
            // Store that we're coming from role selection
            sessionStorage.setItem('from_role_selection', 'true');
